...
public:
	...
	~LcTextureLoaderDX10();
	//
	bool LoadTexture(const LcPath& texPath, ID3D10Device1* device, ID3D10Texture2D** texture, ID3D10ShaderResourceView1** view, LcSize* outTexSize);
	//
...
protected:
	...
	//
	std::map<LcPath, LcTextureDataDX10> texturesCache;
