...
/**
* Create ortho matrix */
CORE_API LcMatrix4 OrthoMatrix(float widthPixels, float heightPixels, float nearPlane, float farPlane, bool flipY = true, bool transpose = true);
/**
* Create ortho matrix */
CORE_API LcMatrix4 OrthoMatrix(LcSize viewportSize, float nearPlane, float farPlane, bool flipY = true, bool transpose = true);
/**
* Create look at matrix */
CORE_API LcMatrix4 LookAtMatrix(LcVector3 from, LcVector3 to, bool transpose = true);
/**
* Create translation matrix */
CORE_API LcMatrix4 TranslationMatrix(LcVector3 pos);
/**
* Create transform matrix */
CORE_API LcMatrix4 TransformMatrix(LcVector3 pos, LcVector2 scale, float rotZ = 0.0f, bool flipY = true, bool transpose = true);
/**
* Transpose matrix */
